    ...
    config.buttons = [
        ...
        },
        {
            ...
            create: function (btnConfig) {
                ...
                var i = document.createElement('i');
                i.setAttribute('style', 'position: relative; top: 1px; margin-right: 4px; width: 13px; height: 13px; background: transparent url(' + xt.data.get("data/img/buffer_twitter_small.png") + ') no-repeat top left;');
